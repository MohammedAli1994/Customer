    ...
    while ($row = mysqli_fetch_assoc($results)) {
        ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="/Customer/add.php?id=<?php echo $row['id']; ?>" class="btn btn-primary">EDIT</a>
                                        <a href="/Customer/delete.php?id=<?php echo $row['id']; ?>" class="btn btn-danger" onClick="javascript:return confirm('Do you really want to delete?');" >DELETE</a>
                                    </td>
                                </tr>
